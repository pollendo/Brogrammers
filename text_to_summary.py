...
def make_summary(input_string="This is a dummy text"):
    print('making_summary')
    # !! This is where you put the input text !!
    number_of_sentences_in_summary = 1
    # article_text = ""
    # for p in paragraphs:
    #    article_text += p.text
    article_text = input_string
